...
export default class SectionTwo extends Component {
  render() {
    return (
      ...
      <div className="col-md-6">
      <div className="algn">
      <h1>WE KNOW HOW DIFFICULT GETTING STARTED CAN BE</h1>
      <h5>Interactively procrastinate high-payoff content without backward-compatible data.</h5>
      <h2>CREATING YOUR STYLE</h2>
      <p>Collaboratively administrate empowered markets via plug-and-play networks dynamically procrastinate B2C users.Uniquely matrix economically sound value through cooperative technology.</p>
      <h2>PLANNING YOUR SCHEME</h2>
