...
export default class Sectionfirst extends Component {
  ...
  <div className="col-md-6 pr-5" style={{fontSize:"1.2em"}}>
        <p className="m-5 txt-para">At Stately Residence, we mainly concentrated on accessories, lamps, and fixtures as it had a beautiful living room and needed some de-cluttering. We enhanced the place with beautiful and spacious wooden cabinets. Our staged home was sold in less than 24 hours!</p>
